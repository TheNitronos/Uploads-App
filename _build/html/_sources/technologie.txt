...
personnaliser, modifier votre code html. Et cela aussi bien en y ajoutant des
couleur, des grilles, des bordures,... Exemple sur la page HTML:
...
boite de dialogue avec javascript:
...
allons donc créer remplacer le code javascript d'avant par un autre qui 
affichera cette boite de dialogue seulement après le chargement:

.. code-block:: javascript
    
    /* on se réfère au document ouvert, donc la page qui quand elle est ouverte
...
intuitive une fois que l'on a appréhender le fonctionnement de celle-ci. Tout
comme python le langage django est relativement facile à comprendre et permet 
de proposer un site web efficace avec effort qui est moindre.
...
jQuery Mobile de base avec un rendu sur smartphone:
