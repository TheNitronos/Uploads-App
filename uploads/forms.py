...
class UploadForm(forms.Form):
    image = forms.ImageField(error_messages={'required': 'Aucune image n\'a été sélectionnée'}, widget=forms.FileInput(attrs={'id': 'imageInput', 'onchange': 'loadFile(this)', 'accept': 'image/*'}))
